...
import com.assessment.stockapi.payload.responses.ApiResponse;
import com.assessment.stockapi.payload.responses.ErrorResponse;
...
//    }
    ...
    public ResponseEntity<ErrorResponse> stockNotFoundException(StockNotFoundException ex) {
        return createHttpResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }
}
